...
DrawLine.prototype.startDrag = function (dragObj) {
	...
	function move (e) {
		self.data.curPoint.y2 = (event.type == 'touchmove') ? event.touches[0].clientY : e.clientY;
		self.data.curPoint.x2 = (event.type == 'touchmove') ? event.touches[0].clientX : e.clientX;
